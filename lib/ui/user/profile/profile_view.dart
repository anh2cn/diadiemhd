                          ...
                          _HeaderWidget(
                            ...
                            viewAllClicked: () {
                              Navigator.pushNamed(
                                  ...
                                  arguments: ItemListIntentHolder(userId: productProvider
                                      .psValueHolder.loginUserId,status: widget.status,
...
class _PendingListingDataWidget extends StatefulWidget {
  ...
  @override
  ___PendingListingDataWidgetState createState() => ___PendingListingDataWidgetState();
}

class ___PendingListingDataWidgetState extends State<_PendingListingDataWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return SliverToBoxAdapter(
        child: ChangeNotifierProvider<PendingProductProvider>(
            ...
            child: Consumer<PendingProductProvider>(builder: (BuildContext context,
                PendingProductProvider itemProvider, Widget child) {
              return AnimatedBuilder(
                  animation: widget.animationController,
...
class _DisabledListingDataWidget extends StatefulWidget {
  ...
  @override
  __DisabledListingDataWidgetState createState() => __DisabledListingDataWidgetState();
}

class __DisabledListingDataWidgetState extends State<_DisabledListingDataWidget> {
  ProductRepository itemRepository;
  ...
  Widget build(BuildContext context) {
    ...
    return SliverToBoxAdapter(
        child: ChangeNotifierProvider<DisabledProductProvider>(
            ...
            child: Consumer<DisabledProductProvider>(builder: (BuildContext context,
                DisabledProductProvider itemProvider, Widget child) {
              return AnimatedBuilder(
                  animation: widget.animationController,
                  child: (itemProvider.itemList.data != null &&
                          itemProvider.itemList.data.isNotEmpty)
...
class _RejectedListingDataWidget extends StatefulWidget {
  ...
  @override
  ___RejectedListingDataWidgetState createState() => ___RejectedListingDataWidgetState();
}

class ___RejectedListingDataWidgetState extends State<_RejectedListingDataWidget> {
  ProductRepository itemRepository;
  ...
  Widget build(BuildContext context) {
    ...
    return SliverToBoxAdapter(
        child: ChangeNotifierProvider<RejectedProductProvider>(
            ...
            child: Consumer<RejectedProductProvider>(builder: (BuildContext context,
                RejectedProductProvider itemProvider, Widget child) {
              return AnimatedBuilder(
                  animation: widget.animationController,
                  child: (itemProvider.itemList.data != null &&
                          itemProvider.itemList.data.isNotEmpty)
